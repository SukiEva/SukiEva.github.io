...
$(function () {
    //获取处理友链数据
    $.getJSON(
        "https://picgo-1303870432.cos.ap-shanghai.myqcloud.com/blog/friend.json",
        function (data) {
            // var data0 = data[0];
            $(".links-content").html("");
            ...
            $(".links-content").append(
                "<div class='friend-title-item'><progress class='progress is-info' max='100'></progress></div>"
            );
            $.each(data, function (i, e) {
                var html = '<div class="friend-card-item">';
                if (e.src == undefined) {
                    html +=
                        '    <img class="ava" src="/img/nopic.jpg" title="图片链接不可用，使用的默认图片">';
                } else {
            ...
            if (notValid.length > 0) {
                $(".links-content").append(
                    "<div class='friend-title-item'><br>阵亡将士<br><br><hr></div></div>"
                );
