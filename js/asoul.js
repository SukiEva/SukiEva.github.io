...
(async function () {
    ...
    const 引流 = ["https://space.bilibili.com/14913306/"];
  ...
  `;
    ...
    function 加载圣·嘉然() {
        ...
        //     ".pio-container .pio-action .pio-close"
        // );
        // closeBtn.insertAdjacentHTML(
        //     "beforebegin",
        //     '<span class="pio-top"></span>'
        // );
        // const topBtn = document.querySelector(
        //     ".pio-container .pio-action .pio-top"
        // );
        // // 返回顶部
    ...
    function onModelLoad(model) {
        ...
        if (modelNmae === "Diana") {
            ...
            initConfig.content.skin[1] = [
                "我是<s>拉胯</s>Gamer担当 向晚 AvA~",
                "怎么推流辣！",
                "AAAAAAAAAAvvvvAAA 向晚！",
            ];
            playAction({
                motion: "Tap左眼",
                from: {
